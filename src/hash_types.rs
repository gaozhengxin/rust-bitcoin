...
hash_newtype!(MTPHash, sha256d::Hash, 32, doc="A hash of the Merkle tree proof");
hash_newtype!(Reserved, sha256d::Hash, 32, doc="A hash of the reserved");
hash_newtype!(MerkleRootMNList, sha256d::Hash, 32, doc="A hash of the Merkle tree branch or root for transactions");
hash_newtype!(MerkleRootQuorums, sha256d::Hash, 32, doc="A hash of the Merkle tree branch or root for transactions");
...
impl_hashencode!(MTPHash);
impl_hashencode! (Reserved);
